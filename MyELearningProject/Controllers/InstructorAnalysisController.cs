...
namespace MyELearningProject.Controllers
{
    public class InstructorAnalysisController : Controller
    {
        ...
        {
            int id = 2;
            var v1 = context.Instructors.Where(x => x.Name == "Engin " && x.Surname == "Demiroğ").Select(y => y.InstructorId).FirstOrDefault();
        ...
        {
            var v1 = context.Courses.Where(x => x.InstructorId == 2).ToList();
